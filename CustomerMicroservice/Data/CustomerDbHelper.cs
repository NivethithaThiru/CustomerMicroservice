...
namespace CustomerMicroservice.Data
{
    public static class CustomerDbHelper
    {
        ...
        {
            new Customer(){CustomerId = 1000, FirstName = "Rohini", LastName = "Thorat", Address = "Mumbai", DateOfBirth = new DateTime(1999,02,02), PanNumber = "MFPFS10001A", Password = "ABCa12345" },
